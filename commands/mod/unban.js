...
module.exports = {
    ...
    run: async (bot, message, args) => {
       ...
       .setDescription(`**You Dont Have The Permissions To Unban Someone!**`)
       .setColor("#12abff")

       const e2 =  new MessageEmbed()
       .setDescription(`**Please Enter A Name!**`)

       .setColor("#12abff")
       const e3 =  new MessageEmbed()
       .setDescription(`**Please Provide A Valid Username, Tag Or ID Or The User Is Not Banned!**`)
      
       .setColor("#12abff")
       const e4 =  new MessageEmbed()
       .setDescription(`**I Don't Have Permissions To Unban Someone!**`)
